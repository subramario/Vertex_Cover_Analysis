...
double cnf_sat_runtime;
double approx_vc1_runtime;
double approx_vc2_runtime;
...
void threaded_vc(unsigned int num_vert, std::vector<unsigned int> adj_list_1[], vector<unsigned int> adj_list_2[], vector<unsigned int> adj_list_3[]){
    ...
    // std::fstream file;
    // file.open("run_times.csv", ios::out | ios::app);
    // file << cnf_sat_runtime << "," << approx_vc1_runtime << "," << approx_vc2_runtime << "\n";


    
    std::cout << "Time taken for CNF SAT - " << cnf_sat_runtime << std::endl;
    std::cout << "Time taken for APPROX-VC-1 - " << approx_vc1_runtime << std::endl;
    std::cout << "Time taken for APPROX-VC-2 - " << approx_vc2_runtime << std::endl;
